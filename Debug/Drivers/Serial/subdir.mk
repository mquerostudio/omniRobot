...
Drivers/Serial/%.o Drivers/Serial/%.su Drivers/Serial/%.cyclo: ../Drivers/Serial/%.c Drivers/Serial/subdir.mk
...
clean: clean-Drivers-2f-Serial

clean-Drivers-2f-Serial:
	-$(RM) ./Drivers/Serial/serial.cyclo ./Drivers/Serial/serial.d ./Drivers/Serial/serial.o ./Drivers/Serial/serial.su

.PHONY: clean-Drivers-2f-Serial
