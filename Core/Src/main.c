...
uint8_t vel0[1], theta0[5], omega0[1];
int velint, thetaint, omegaint;
float vel, theta;
...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
MOTOR_HandleTypeDef motorUno;
MOTOR_HandleTypeDef motorDos;
MOTOR_HandleTypeDef motorTres;
